...
public interface PublisherConfiguration extends ConfigProp {
    ...
    String NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_CONNECT_PROPERTY_NAME = "notification.request.timeout.ms.connect";
    int NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_CONNECT_DEFAULT_VALUE = 100;

    String NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_READ_PROPERTY_NAME = "notification.request.timeout.ms.read";
    int NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_READ_DEFAULT_VALUE = 300;

    String NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_CONNECTION_MANAGER_PROPERTY_NAME = "notification.request.timeout.ms.conn.mgr";
    ...
    String NOTIFICATION_REQUEST_RETRY_INTERVAL_MILLISECOND_PROPERTY_NAME = "notification.request.retry.interval.ms";
    ...
    default int getRequestTimeoutInMillisec() {
        return getIntProperty(NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_CONNECT_PROPERTY_NAME, NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_CONNECT_DEFAULT_VALUE);
    }

    default int getSocketTimeoutInMillisec() {
        return getIntProperty(NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_READ_PROPERTY_NAME, NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_READ_DEFAULT_VALUE);
    }

    default int getConnectionMgrTimeoutInMillisec() {
        return getIntProperty(NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_CONNECTION_MANAGER_PROPERTY_NAME, NOTIFICATION_REQUEST_TIMEOUT_MILLISECOND_CONNECTION_MANAGER_DEFAULT_VALUE);
    }
    ...
    default int getRequestRetryInterval() {
        return getIntProperty(NOTIFICATION_REQUEST_RETRY_INTERVAL_MILLISECOND_PROPERTY_NAME, NOTIFICATION_DEFAULT_RETRY_INTERVAL_MILLISECOND_DEFAULT_VALUE);
    }
